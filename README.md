...
| [GitHub CLI](https://cli.github.com/) | `winget install --id GitHub.cli --source winget` | `sudo apt install gh` |
...
| [Helix](https://helix-editor.com/) | `winget install Helix.Helix` | `sudo add-apt-repository ppa:maveonair/helix-editor` <br> `sudo apt update` <br> `sudo apt install helix` |
